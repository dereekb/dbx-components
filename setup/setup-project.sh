...
npm install -D firebase-tools@11.4.0 @ngrx/store-devtools@^14.1.0 @ngx-formly/schematics@6.0.0-rc.2 @firebase/rules-unit-testing@^2.0.4 firebase-functions-test@2.3.0 envfile env-cmd
