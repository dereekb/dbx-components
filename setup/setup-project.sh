...
then
  ...
  DBX_COMPONENTS_VERSION_ANALYTICS=$CI_DIST_PATH/analytics
  DBX_COMPONENTS_VERSION_CALCOM=$CI_DIST_PATH/calcom
  ...
  DBX_COMPONENTS_VERSION_ZOOM=$CI_DIST_PATH/zoom
  ...
  DBX_COMPONENTS_VERSION_ANALYTICS=$DBX_COMPONENTS_VERSION
  DBX_COMPONENTS_VERSION_CALCOM=$DBX_COMPONENTS_VERSION
...
install_local_peer_deps "$DBX_COMPONENTS_VERSION_ANALYTICS"
install_local_peer_deps "$DBX_COMPONENTS_VERSION_CALCOM"
...
download_api_ts_file "src/app/common/model/storagefile/storagefile.init.ts"
