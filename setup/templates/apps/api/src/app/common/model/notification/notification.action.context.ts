...
export abstract class APP_CODE_PREFIXFirebaseServerActionsContextWithNotificationServices extends APP_CODE_PREFIXFirebaseServerActionsContext implements NotificationTemplateServiceRef, NotificationSendServiceRef, AppNotificationTemplateTypeInfoRecordServiceRef {
