...
import { APP_CODE_PREFIX_LOWERDevelopmentFunctionMap, APP_CODE_PREFIXDevelopmentFunctions, APP_CODE_PREFIXDevelopmentFunctionTypeMap } from './development';
...
export const APP_CODE_PREFIX_UPPER_FIREBASE_FUNCTIONS_CONFIG: FirebaseFunctionsConfigMap<APP_CODE_PREFIXFirebaseFunctionsMap> = {
  ...
  developmentFunctions: [APP_CODE_PREFIXDevelopmentFunctions, APP_CODE_PREFIX_LOWERDevelopmentFunctionMap]
};
