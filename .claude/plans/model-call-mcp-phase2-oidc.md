...
- [x] Create `oauth-client-list.component.ts` — `DbxFirebaseOidcEntryClientListComponent` with `OAuthClient` interface
- [x] Create `oauth-client-detail.component.ts` — `DbxFirebaseOidcEntryClientDetailComponent` with revoke action
