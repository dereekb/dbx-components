...
export const APP_CONFIG: ApplicationConfig = {
  providers: [
    ...
    provideDbxLinkify({
      dbxLinkifyServiceConfigFactory: () => ({
        defaultEntry: {
          options: {}
        },
        entries: [{ type: 'no-target', options: { defaultProtocol: 'https' } }]
      })
    }),
    // dbx-web extensions
    provideDbxCalendar(),
    ...
    provideDbxFirebaseOidc({
      ...
      oidcConfig: {
        ...
        availableProviderProfiles: DEMO_OIDC_PROVIDER_PROFILE_DETAILS,
