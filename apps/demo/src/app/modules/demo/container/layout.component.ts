...
import { DbxSidenavComponent, DbxColorDirective, DbxSetStyleDirective, DbxIfSidenavDisplayModeDirective, DbxContentBorderDirective, DbxSidenavPageComponent, DbxAnchorListComponent, DbxWebPageTitleInfoDirective, type DbxWebPageTitleInfoConfig } from '@dereekb/dbx-web';
...
export class DemoLayoutComponent {
  ...
  readonly pageTitleInfo: DbxWebPageTitleInfoConfig = { title: 'Demo', description: 'dbx-components demo app' };
