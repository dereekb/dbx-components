...
@Component({
  ...
  standalone: true,
  imports: [DbxContentContainerDirective, DocFeatureLayoutComponent, DocHeroCardExampleComponent, DocSupportBannerCardExampleComponent, DocFeedbackSelectionCardExampleComponent],
