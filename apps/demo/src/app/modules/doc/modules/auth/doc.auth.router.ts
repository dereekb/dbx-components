...
export const DOC_AUTH_ROLE_STATE: Ng2StateDeclaration = {
  url: '/role',
  name: 'doc.auth.role',
  component: DocAuthRoleComponent
};

export const DOC_AUTH_FIREBASE_STATE: Ng2StateDeclaration = {
  url: '/firebase',
  name: 'doc.auth.firebase',
  component: DocAuthFirebaseComponent
};

export const STATES: Ng2StateDeclaration[] = [LAYOUT_STATE, HOME_STATE, DOC_AUTH_ROLE_STATE, DOC_AUTH_FIREBASE_STATE];
