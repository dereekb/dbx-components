...
export const DEMO_CLI_FIRESTORE_QUERY_MANIFEST: CliFirestoreQueryManifest = [
  {
    ...
    reachability: { verdict: 'reachable', list: 'allowed', collectionGroup: false },
  ...
  },
  {
    ...
    reachability: { verdict: 'reachable', list: 'allowed', collectionGroup: true, parentPaths: ['gb/{guestbook}'] },
