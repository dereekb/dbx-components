...
export const storageFileDownload: DemoReadModelFunction<DownloadStorageFileParams, DownloadStorageFileResult> = withApiDetails({
  inputType: downloadStorageFileParamsType,
  fn: async (request) => {
...
export const storageFileDownloadMultiple: DemoReadModelFunction<DownloadMultipleStorageFilesParams, DownloadMultipleStorageFilesResult> = withApiDetails({
  inputType: downloadMultipleStorageFilesParamsType,
  fn: async (request) => {
    const { nest, data } = request;
