...
/**
 * The only checkpoint {@link demoGuestbookFormSpaceSubmissionProcessor} runs.
 */
export const DEMO_GUESTBOOK_FORM_SPACE_CLOSE_SUBTASK = 'close';

/**
 * Builds the demo app's submission processor for {@link DEMO_GUESTBOOK_FORM_SPACE_TYPE}.
 *
 ...
 *
 * @returns The submission processor config targeting the demo guestbook form.
 */
export function demoGuestbookFormSpaceSubmissionProcessor(): FormSpaceSubmissionProcessorConfig {
