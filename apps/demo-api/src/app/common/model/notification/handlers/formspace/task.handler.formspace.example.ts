...
/**
 * Builds the demo app's submission processor for {@link DEMO_EXAMPLE_FORM_SPACE_TYPE}.
 *
 ...
 *
 * @returns The submission processor config targeting the demo example form.
 */
export function demoExampleFormSpaceSubmissionProcessor(): FormSpaceSubmissionProcessorConfig {
