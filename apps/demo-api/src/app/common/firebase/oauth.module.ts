...
import { FIREBASE_APP_TOKEN, FIREBASE_AUTH_TOKEN, FirebaseServerAuthModule } from '@dereekb/firebase-server';
...
@Module({
  imports: [
    OAuthModule.forRootAsync({
      ...
      useFactory: (app: admin.app.App, auth: admin.auth.Auth) => ({
      ...
      inject: [FIREBASE_APP_TOKEN, FIREBASE_AUTH_TOKEN]
    })
  ],
  exports: [OAuthModule]
})
