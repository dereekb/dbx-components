...
import type { DerivedComposite, DerivedFieldOverride, DerivedFieldOverrideVariant, DerivedIndexField, FirestoreIndexOrder } from '../manifest/model-firebase-index-schema.js';
