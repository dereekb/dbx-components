...
const BUNDLED_UTIL = resolve(PACKAGE_ROOT, 'generated', 'dereekb-util.semantic-types.mcp.generated.json');
const BUNDLED_MODEL = resolve(PACKAGE_ROOT, 'generated', 'dereekb-model.semantic-types.mcp.generated.json');
