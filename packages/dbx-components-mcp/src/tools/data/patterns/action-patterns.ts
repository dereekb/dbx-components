...
export const ACTION_EXAMPLE_PATTERNS: readonly ActionExamplePattern[] = [
  ACTION_PATTERN_BUTTON_CONFIRM_DELETE,
  ACTION_PATTERN_FORM_SUBMIT,
  ACTION_PATTERN_FORM_WITH_SECONDARY,
  ACTION_PATTERN_AUTO_TRIGGER_ON_MODIFY,
  ACTION_PATTERN_DISABLED_BY_KEY,
  ACTION_PATTERN_VALUE_GETTER_ON_TRIGGER,
