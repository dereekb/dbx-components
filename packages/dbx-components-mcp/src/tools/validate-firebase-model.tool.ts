/**
 * `dbx_validate_firebase_model` tool.
 *
...
import { formatResult, validateFirebaseModelSources, type ValidatorSource } from './validate-firebase-model/index.js';

// MARK: Tool definition
const DBX_VALIDATE_FIREBASE_MODEL_TOOL: Tool = {
  name: 'dbx_validate_firebase_model',
  description: [
...
// MARK: Handler
export async function runValidateFirebaseModel(rawArgs: unknown): Promise<ToolResult> {
  let args: ParsedArgs;
  try {
...
export const validateFirebaseModelTool: DbxTool = {
  definition: DBX_VALIDATE_FIREBASE_MODEL_TOOL,
  run: runValidateFirebaseModel
};
