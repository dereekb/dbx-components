  ...
  function buildTestsWithClass<C extends TestInjectionContextDirective>(type: Type<C>, selector: string): void {
    ...
    describe(`selector "${selector}"`, () => {
      ...
      describe('showContext()', () => {
        ...
        it(
          'should show the config-injected content then back to the normal content when done.',
          callbackTest((done) => {
            assetExistingContentVisible();
      ...
      describe('resetContext()', () => {
        it(
          'should reset the context immediately without use() returning.',
          callbackTest((done) => {
            directive
              .showContext({
                config: {
        ...
        it(
          'reset, show, reset, show, reset, show.',
          callbackTest((done) => {
