...
import { ANALYTICS_COMMAND } from './lib/commands/analytics.command';
 ...
 */
const apiCommands: CommandModule[] = [RECRUIT_COMMAND, CRM_COMMAND, DESK_COMMAND, SIGN_COMMAND, ANALYTICS_COMMAND, REQUEST_COMMAND];
