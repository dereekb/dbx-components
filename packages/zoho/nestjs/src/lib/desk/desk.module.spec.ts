...
export class TestZohoDeskDependencyModule {}

// example of providing the dependency module
@Module(appZohoDeskModuleMetadata({ dependencyModule: TestZohoDeskDependencyModule }))
export class TestZohoDeskModule {}

// module without the required dependency
@Module(appZohoDeskModuleMetadata({}))
export class TestZohoDeskModuleWithoutDependency {}

describe('appZohoDeskModuleMetadata()', () => {
  ...
  it('should fail to compile when ZohoAccountsAccessTokenCacheService is not provided', async () => {
    const rootModule: DynamicModule = {
      module: TestZohoDeskModuleWithoutDependency,
      global: true
    };
    ...
    describe('accountsContext', () => {
      describe('loadAccessToken()', () => {
        it('should return a non-expired access token', async () => {
          ...
          const cachedToken = await deskTokenCache.loadCachedToken();
