import { AbstractJestTestContextFixture, type TestContextFactory } from '@dereekb/util/test';
...
export type JestTestFirestoreContextFactory = TestContextFactory<TestFirestoreContextFixture>;
