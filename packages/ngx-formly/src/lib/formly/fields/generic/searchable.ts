 ...
 * Displayed value.
 */
export interface SearchableValueFieldDisplayValue<T, M = any> extends PickableValueFieldDisplayValue<T, M>, SearchableValueFieldValue<T, M> {
  sublabel?: string;
  /**
...
export type SearchableValueFieldHashFn<T> = PickableValueFieldHashFn<T>;
