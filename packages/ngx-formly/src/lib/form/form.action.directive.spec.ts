...
import { DbNgxActionContextDirective, DbNgxActionModule } from '@dereekb/ngx-core';
...
describe('FormActionDirective', () => {
  ...
  describe('when form valid', () => {
    ...
    beforeEach(() => {
      ...
      expect(form.context.isComplete).toBeTrue();
    });
  ...
  describe('when form is invalid', () => {
    ...
    beforeEach(() => {
      ...
      expect(form.context.isComplete).toBeFalse();
    });
