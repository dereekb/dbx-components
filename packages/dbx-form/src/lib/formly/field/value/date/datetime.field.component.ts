import { type Maybe, type ReadableTimeString, type ArrayOrValue, type ISO8601DateString, asArray, filterMaybeArrayValues, type DecisionFunction, type Milliseconds, type TimezoneString, type LogicalDate, type DateOrDayString, isISO8601DayStringStart, type MapFunction, mapIdentityFunction, type MinuteOfDay, type UnixDateTimeMillisecondsNumber, type ISO8601DayString } from '@dereekb/util';
import { dateFromLogicalDate, type DateTimeMinuteConfig, DateTimeMinuteInstance, guessCurrentTimezone, readableTimeStringToDate, toLocalReadableTimeString, utcDayForDate, safeToJsDate, findMinDate, findMaxDate, isSameDateHoursAndMinutes, getTimezoneAbbreviation, isSameDateDay, dateTimezoneUtcNormal, type DateTimezoneUtcNormalInstance, toJsDayDate, isSameDate, dateTimeMinuteWholeDayDecisionFunction, dateTimeMinuteDecisionFunction } from '@dereekb/date';
import { switchMap, shareReplay, map, startWith, tap, first, distinctUntilChanged, debounceTime, throttleTime, BehaviorSubject, type Observable, combineLatest, Subject, merge, interval, of, combineLatestWith, filter, skip } from 'rxjs';
import { ChangeDetectionStrategy, Component, type OnDestroy, type OnInit, inject } from '@angular/core';
import { type AbstractControl, FormControl, Validators, type FormGroup, type ValidationErrors, ReactiveFormsModule, FormsModule } from '@angular/forms';
...
import { type FormControlPath, streamValueFromControl } from '../../../../form/form.angular.util';
