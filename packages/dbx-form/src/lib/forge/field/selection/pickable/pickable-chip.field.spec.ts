...
// ============================================================================
// DbxForgeFormFieldWrapperWrappedFieldDef<DbxForgePickableChipFieldDef> - Structure
// ============================================================================

describe('DbxForgeFormFieldWrapperWrappedFieldDef<DbxForgePickableChipFieldDef>', () => {
  it('fields[0] is typed as DbxForgePickableChipFieldDef', () => {
    type WrapperFieldDef = DbxForgeFormFieldWrapperWrappedFieldDef<DbxForgePickableChipFieldDef>;
    expectTypeOf<WrapperFieldDef['fields'][0]>().toEqualTypeOf<DbxForgePickableChipFieldDef>();
  });
});
...
describe('forgePickableChipField()', () => {
  ...
  it('should create an inner field with dbx-pickable-chip type', () => {
    const inner = getDbxForgeFormFieldWrapperWrappedField(forgePickableChipField(minimalConfig()));
  ...
  it('should set label on the inner field', () => {
    const inner = getDbxForgeFormFieldWrapperWrappedField(forgePickableChipField({ ...minimalConfig(), label: 'Tags' }));
    expect(inner.label).toBe('Tags');
  });

  // MARK: Required/readonly passthrough
  it('should set required on the inner field when provided', () => {
    const inner = getDbxForgeFormFieldWrapperWrappedField(forgePickableChipField({ ...minimalConfig(), required: true }));
  ...
  it('should set readonly on the inner field when provided', () => {
    const inner = getDbxForgeFormFieldWrapperWrappedField(forgePickableChipField({ ...minimalConfig(), readonly: true }));
    expect(inner.readonly).toBe(true);
  });

  // MARK: Hint/description mapping
  it('should map description to inner field props.hint', () => {
    const inner = getDbxForgeFormFieldWrapperWrappedField(forgePickableChipField({ ...minimalConfig(), description: 'Pick your tags' }));
    expect(inner.props?.hint).toBe('Pick your tags');
  });

  it('should map hint to inner field props.hint', () => {
    const inner = getDbxForgeFormFieldWrapperWrappedField(forgePickableChipField({ ...minimalConfig(), hint: 'Pick your tags' }));
    expect(inner.props?.hint).toBe('Pick your tags');
  });
  ...
  it('should propagate multiSelect through inner field props when provided', () => {
    const inner = getDbxForgeFormFieldWrapperWrappedField(forgePickableChipField({ ...minimalConfig(), props: { ...minimalConfig().props!, multiSelect: false } }));
  ...
  it('should propagate asArrayValue through inner field props when provided', () => {
    const inner = getDbxForgeFormFieldWrapperWrappedField(forgePickableChipField({ ...minimalConfig(), props: { ...minimalConfig().props!, asArrayValue: false } }));
  ...
  it('should propagate filterValues through inner field props when provided', () => {
    ...
    const inner = getDbxForgeFormFieldWrapperWrappedField(forgePickableChipField(config));
  ...
  it('should propagate filterLabel through inner field props when provided', () => {
    const inner = getDbxForgeFormFieldWrapperWrappedField(forgePickableChipField({ ...minimalConfig(), props: { ...minimalConfig().props!, filterLabel: 'Search tags' } }));
  ...
  it('should pass logic through to the inner field definition', () => {
    ...
    const inner = getDbxForgeFormFieldWrapperWrappedField(forgePickableChipField({ ...minimalConfig(), logic }));
  ...
  it('should pass validators through to the inner field definition', () => {
    ...
    const inner = getDbxForgeFormFieldWrapperWrappedField(forgePickableChipField({ ...minimalConfig(), validators }));
  ...
  it('should pass validationMessages through to the inner field definition', () => {
    ...
    const inner = getDbxForgeFormFieldWrapperWrappedField(forgePickableChipField({ ...minimalConfig(), validationMessages }));
