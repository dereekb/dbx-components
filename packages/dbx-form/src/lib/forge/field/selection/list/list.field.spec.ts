...
describe('forgeListSelectionField()', () => {
  ...
  describe('with wrapper (default)', () => {
    ...
    it('should set the inner field type to dbx-list-selection', () => {
      const wrapper = forgeListSelectionField(minimalConfig()) as ForgeFormFieldWrapperFieldDef;
    ...
    it('should set empty label on the inner field', () => {
      const wrapper = forgeListSelectionField({ ...minimalConfig(), label: 'Items' }) as ForgeFormFieldWrapperFieldDef;
      const inner = getInnerField(wrapper);
      expect(inner.label).toBe('');
    });

    it('should set required on the inner field when provided', () => {
      const wrapper = forgeListSelectionField({ ...minimalConfig(), required: true }) as ForgeFormFieldWrapperFieldDef;
      const inner = getInnerField(wrapper);
    ...
    it('should set readonly on the inner field when provided', () => {
      const wrapper = forgeListSelectionField({ ...minimalConfig(), readonly: true }) as ForgeFormFieldWrapperFieldDef;
      const inner = getInnerField(wrapper);
    ...
    it('should map description to wrapper props.hint', () => {
      ...
      expect((wrapper as ForgeFormFieldWrapperFieldDef).props?.hint).toBe('Select items from the list');
    });

    it('should not set hint on wrapper when description is not provided', () => {
      const wrapper = forgeListSelectionField(minimalConfig());
      expect((wrapper as ForgeFormFieldWrapperFieldDef).props?.hint).toBeUndefined();
    });
    ...
    it('should propagate loadMore through inner field props when provided', () => {
      const loadMore = () => {};
      const wrapper = forgeListSelectionField({ ...minimalConfig(), loadMore }) as ForgeFormFieldWrapperFieldDef;
      const inner = getInnerField(wrapper);
