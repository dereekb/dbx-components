...
import { FieldWrapperContract, WrapperFieldInputs, ARRAY_CONTEXT } from '@ng-forge/dynamic-forms';
...
export class DbxForgeArrayFieldElementWrapperComponent implements FieldWrapperContract {
  ...
  // private readonly arrayFieldState = inject(DbxForgeArrayFieldState);
