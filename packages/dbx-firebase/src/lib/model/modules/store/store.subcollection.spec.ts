...
import { type MockItemSubItem, type MockItemSubItemDocument, authorizedTestWithMockItemCollection, type MockItem, type MockItemDocument, MockItemCollections } from '@dereekb/firebase/test';
...
describe('AbstractDbxFirebaseCollectionWithParentStore', () => {
  authorizedTestWithMockItemCollection((f) => {
    ...
    beforeEach(() => {
      ...
      store = newWithInjector(TestDbxFirebaseCollectionWithParentStore, injector);
