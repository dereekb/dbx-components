...
import { buildModelFirebaseIndexManifest, formatModelFirebaseIndexBuildWarning, serializeModelFirebaseIndexManifest, type BuildModelFirebaseIndexGlobber } from '../../../../firestore-indexes/src/model-firebase-index-build-manifest.js';
