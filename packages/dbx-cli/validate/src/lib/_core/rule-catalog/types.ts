...
export type RuleSource =
  | 'dbx_model_validate'
  | 'dbx_model_validate_api'
  | 'dbx_model_validate_folder'
  | 'dbx_model_fixture_validate_app'
  | 'dbx_model_api_validate_app'
  | 'dbx_model_firebase_index_validate_app'
  | 'dbx_model_server_only_validate_app'
  | 'dbx_model_test_validate_app'
  | 'dbx_storagefile_m_validate_app'
  | 'dbx_storagefile_m_validate_folder'
  | 'dbx_notification_m_validate_app'
