...
import {
  SUB_OBJECT_FACTORY_NAMES,
  type ExtractedArchetypeTagInfo,
  type ExtractedCompositeKeyTagInfo,
  type ExtractedDataInterface,
  type ExtractedDecl,
  type ExtractedDocumentClass,
  type ExtractedField,
  type ExtractedFile,
  type ExtractedGroupInterface,
  type ExtractedGroupTypes,
  type ExtractedIdentity,
  type ExtractedModel,
  type ExtractedSubObjectFactoryCall,
  type ModelVariant,
  type SubObjectFactoryName,
