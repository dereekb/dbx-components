...
import type { RequiredApiFile, SideInspection as SharedSideInspection, TwoSideFolderInspection, TwoSideFolderValidationResult, TwoSideFolderViolation } from '../_core/validate-two-side-folder.js';
import type { NotificationMValidateFolderCode } from './codes.js';

export type { SideStatus, ViolationSeverity } from '../_core/validate-two-side-folder.js';
