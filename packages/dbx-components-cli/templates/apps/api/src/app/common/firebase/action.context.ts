...
export abstract class APP_CODE_PREFIXFirebaseServerActionsContext
  extends APP_CODE_PREFIXFirestoreCollections
  implements FirebaseServerActionsContext, AppNotificationTemplateTypeInfoRecordServiceRef, FirebaseServerAuthServiceRef<APP_CODE_PREFIXApiAuthService>, FirebaseServerStorageServiceRef, MailgunServiceRef, NotificationExpediteServiceRef
{
