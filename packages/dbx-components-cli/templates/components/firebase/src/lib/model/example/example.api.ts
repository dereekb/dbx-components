import { type ExampleTypes } from './example';
import { type ModelFirebaseFunctionMap, callModelFirebaseFunctionMapFactory, type FirebaseFunctionMapFunction, type FirebaseFunctionTypeConfigMap, type ModelFirebaseCrudFunctionConfigMap } from '@dereekb/firebase';
