...
import { yearMonthDayCodeFactory, yearMonthDayCode, yearMonthDayCodeForCalendarMonthFactory, yearMonthDayCodeDateFactory, yearMonthDayCodeGroupFactory, yearMonthDayCodeDay, yearMonthDayCodeMonth } from './date.day';
  ...
  describe('function', () => {
    ...
    describe('date', () => {
      ...
      describe('with timezone', () => {
        const expected2022YearMonthDayCode1 = yearMonthDayCode(2022, 1, 1);
...
describe('yearMonthDayCodeForMonthFactory()', () => {
  describe('function', () => {
    describe('with timezone', () => {
      const expected2022YearMonthDayCode1 = yearMonthDayCode(2022, 1, 1);
      const expected2022YearMonthDayCode2 = yearMonthDayCode(2022, 1, 2);
      const expected2022YearMonthDayCode3 = yearMonthDayCode(2022, 1, 3);
      const expected2022YearMonthDayCode4 = yearMonthDayCode(2022, 1, 4);
      const expected2022YearMonthDayCode5 = yearMonthDayCode(2022, 1, 5);

      const utc2022Week1StartDate = new Date('2021-12-26T00:00:00.000Z'); // date in utc.
      const utc2022Week2StartDate = new Date('2022-01-02T00:00:00Z');

      describe('system', () => {
        const factory = yearMonthDayCodeForCalendarMonthFactory(yearMonthDayCodeFactory()); // defaults to the system when no timezone specified
      ...
      describe('UTC', () => {
        const factory = yearMonthDayCodeForCalendarMonthFactory(yearMonthDayCodeFactory({ timezone: UTC_TIMEZONE_STRING }));
      ...
      describe('America/Denver', () => {
        const factory = yearMonthDayCodeForCalendarMonthFactory(yearMonthDayCodeFactory({ timezone: 'America/Denver' }));
