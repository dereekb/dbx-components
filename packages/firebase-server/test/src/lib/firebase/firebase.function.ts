/* eslint-disable @typescript-eslint/no-deprecated -- file intentionally retains the V2-prefixed wrapper signatures for backward-compatible test infrastructure */
 ...
 */
export type WrappedCloudFunction<I extends object, O = unknown> = (input: I, context?: CallableContextOptions) => Promise<O>; //WrappedGen2CloudOrBlockingFunction<I>
/**
