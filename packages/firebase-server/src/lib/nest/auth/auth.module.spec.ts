          ...
          describe('setup content sent', () => {
            ...
            describe('throwErrors=true', () => {
              itShouldFail('to send and instead throw a throttle error', async () => {
                ...
                await expectFail(() => newUserService.sendSetupContent(initializedUser.uid, { throwErrors: true }), expectFailAssertErrorType(FirebaseServerAuthNewUserSendSetupDetailsThrottleError));
              });
            });
              ...
              describe('onlySendOnce=true', () => {
                ...
                describe('throwErrors=true', () => {
                  itShouldFail('to send and instead throws a send once error', async () => {
                    await expectFail(() => newUserService.sendSetupContent(initializedUser.uid, { sendSetupDetailsOnce: true, throwErrors: true }), expectFailAssertErrorType(FirebaseServerAuthNewUserSendSetupDetailsSendOnceError));
                  });
                });
              });
            });
