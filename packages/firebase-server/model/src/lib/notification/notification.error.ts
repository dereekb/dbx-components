import { CREATE_NOTIFICATION_ID_REQUIRED_ERROR_CODE, FirestoreModelKey, NOTIFICATION_BOX_ALREADY_INITIALIZED_ERROR_CODE, NOTIFICATION_BOX_EXISTS_FOR_MODEL_ERROR_CODE, NOTIFICATION_BOX_RECIPIENT_DOES_NOT_EXIST_ERROR_CODE } from '@dereekb/firebase';
