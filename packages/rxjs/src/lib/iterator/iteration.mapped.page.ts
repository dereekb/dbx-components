...
export class MappedPageItemIterationInstance<
  ...
  L extends PageLoadingState<I> = PageLoadingState<I>,
  N extends PageItemIteration<I, L> = PageItemIteration<I, L>
  > extends MappedItemIterationInstance<O, I, M, L, N> implements PageItemIteration<O, M> {
...
export function mapPageItemIteration<
  ...
  L extends PageLoadingState<I> = PageLoadingState<I>,
  N extends PageItemIteration<I, L> = PageItemIteration<I, L>
>(itemIteration: N, config: MappedItemIterationInstanceMapConfig<O, I, M, L>): MappedPageItemIterationInstance<O, I, M, L, N> {
