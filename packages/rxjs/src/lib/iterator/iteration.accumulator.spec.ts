  ...
  describe('ItemAccumulatorInstance', () => {
    describe('one number per page', () => {
      ...
      describe('successfulLoadCount$', () => {
        it(
          'should return 1 after the first result has been loaded.',
          callbackTest((done) => {
      ...
      describe('currentAllItems$', () => {
        ...
        describe('with array value accumulator', () => {
          ...
          it(
            'should accumulate the array values to a 2 dimensional array.',
            callbackTest((done) => {
          ...
          it(
            'should accumulate the multiple array values to a 2 dimensional array.',
            callbackTest((done) => {
              const pagesToLoad = 2;
          ...
          it(
            'should accumulate the multiple array values to a 2 dimensional array and any subsequent values too.',
            callbackTest((done) => {
              const pagesToLoad = 2;
        ...
        it(
          'should return all items after being subscribed to a few pages in.',
          callbackTest((done) => {
            const pagesToLoad = 5;
        ...
        it(
          'should not emit an empty array before the first state has come through.',
          callbackTest((done) => {
            initInstanceWithFilter({
              delayTime: 500
            });
        ...
        it(
          'should accumulate values as pages are loaded.',
          callbackTest((done) => {
            let emissions = 0;
      ...
      describe('allItems$', () => {
        ...
        it(
          'should not emit an empty array until the first state has come through.',
          callbackTest((done) => {
            initInstanceWithFilter({
              delayTime: 500
            });
      ...
      describe('array of numbers per page', () => {
        ...
        describe('itemAccumulatorNextPageUntilResultsCount()', () => {
          ...
          it(
            'should exit once no more items can be loaded and it is before the target max items',
            callbackTest((done) => {
              instance.destroy();
              accumulator.destroy();
          ...
          it(
            `should call next up until the input item limit is reached, then return the number of results`,
            callbackTest((done) => {
