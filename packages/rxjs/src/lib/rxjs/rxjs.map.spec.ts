...
describe('rxjs.map', () => {
  ...
  describe('combineLatestFromMapValuesObsFn()', () => {
    describe('function', () => {
      it(
        'should combine the latests values of the map',
        callbackTest((done) => {
  ...
  describe('combineLatestFromArrayObsFn()', () => {
    it(
      'should combine the latest value from all the passed observables into a single value.',
      callbackTest((done) => {
...
describe('combineLatestFromObject()', () => {
  ...
  it(
    'should merge all the latest values into a single object.',
    callbackTest((done) => {
      const obs = combineLatestFromObject({
        a: true,
        b: of('string'),
  ...
  it(
    'should wait for a value from each observable to be emitted.',
    callbackTest((done) => {
