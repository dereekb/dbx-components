...
describe('expires operators', () => {
  ...
  describe('toExpiration()', () => {
    it(
      'should create an Expires object that expires in the future',
      callbackTest((done) => {
    ...
    it(
      'should create a new Expires object on each emission',
      callbackTest((done) => {
        const subject = new Subject<number>();
  ...
  describe('skipExpired()', () => {
    it(
      'should filter out expired items',
      callbackTest((done) => {
    ...
    it(
      'should allow items with no expiration date',
      callbackTest((done) => {
        const subject = new Subject<Expires>();
  ...
  describe('skipUntilExpiration()', () => {
    it(
      'should filter out dates until they expire',
      callbackTest((done) => {
    ...
    it(
      'should filter all items when expiresIn is not provided (no expiration defined)',
      callbackTest((done) => {
        const subject = new Subject<Date>();
  ...
  describe('skipAfterExpiration()', () => {
    it(
      'should filter out dates after they expire',
      callbackTest((done) => {
        const subject = new Subject<Date>();
        const expiresIn = 100; // 100ms
    ...
    it(
      'should work without an expiresIn parameter',
      callbackTest((done) => {
        const subject = new Subject<Date>();
  ...
  describe('skipUntilTimeElapsedAfterLastEmission()', () => {
    it(
      'should skip emissions until time has elapsed since last watch emission',
      callbackTest((done) => {
  ...
  describe('takeAfterTimeElapsedSinceLastEmission()', () => {
    it(
      'should take emissions after time has elapsed since last watch emission',
      callbackTest((done) => {
        const watchSubject = new Subject<void>();
        const dataSubject = new Subject<number>();
