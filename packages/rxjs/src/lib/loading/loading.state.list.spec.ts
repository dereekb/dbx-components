...
describe('mapIsListLoadingStateWithEmptyValue()', () => {
  it(
    'should emit true for an empty array.',
    callbackTest((done) => {
  ...
  it(
    'should emit false for a non-empty array.',
    callbackTest((done) => {
...
describe('arrayValueFromFinishedLoadingState()', () => {
  it(
    'should emit an empty array for an empty array.',
    callbackTest((done) => {
  ...
  it(
    'should emit an array for a non-empty array.',
    callbackTest((done) => {
