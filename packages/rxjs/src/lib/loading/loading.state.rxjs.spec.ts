...
describe('mapLoadingStateValueWithOperator()', () => {
  ...
  describe('mapOnUndefined = true', () => {
    it(
      'should not pass through the value when loading is undefined and value is undefined',
      callbackTest((done) => {
    ...
    it(
      'should pass through the value when loading is false and value is undefined',
      callbackTest((done) => {
        const expectedValue = 1;
        let mapAttempted = false;
  ...
  it(
    'should not pass through the value when loading is false and value is undefined',
    callbackTest((done) => {
      let mapAttempted = false;
  ...
  it(
    'should pass through an error when loading is false and value is undefined',
    callbackTest((done) => {
      let mapAttempted = false;
  ...
  it(
    'should return a loading state when the original loading state finishes with a value and when using an async operator that does not immediately return',
    callbackTest((done) => {
      const expectedValues = ['aaa', 'aac'];
      const values = [...expectedValues, 'ddd', 'eee'];
      const values$ = new BehaviorSubject<LoadingState<string[]>>({ value: values });
  ...
  it(
    'should not map undefined success values',
    callbackTest((done) => {
  ...
  it(
    'should map null success values',
    callbackTest((done) => {
...
describe('combineLoadingStates()', () => {
  describe('two loading states', () => {
    it(
      'should return a loading state that is loading.',
      callbackTest((done) => {
  ...
  describe('more loading states', () => {
    ...
    describe('encounters an error', () => {
      it(
        'should return the first error if the error is not marked as loading..',
        callbackTest((done) => {
      ...
      it(
        'should return loading while states that have an error are still marked as loading.',
        callbackTest((done) => {
          const expectedError = new Error();
      ...
      it(
        'should return the error state from the results.',
        callbackTest((done) => {
          const expectedError = new Error();
    ...
    it(
      'should merge each of the values together once finished loading using mergeObjects if a merge function is not provided.',
      callbackTest((done) => {
        const a = of(successResult({ a: true }));
...
describe('combineLoadingStatesStatus()', () => {
  describe('two loading states', () => {
    it(
      'should return a loading state as success with true when all loading states are success',
      callbackTest((done) => {
    ...
    it(
      'should return a loading state as loading when one or more loading states are loading',
      callbackTest((done) => {
    ...
    it(
      'should return a loading state as success after all items have finished loading',
      callbackTest((done) => {
    ...
    it(
      'should return a loading state with an error when one or more loading states have an error',
      callbackTest((done) => {
...
describe('distinctLoadingState()', () => {
  describe('scenario', () => {
    describe('unique model keys', () => {
      ...
      describe('default', () => {
        it(
          'should emit on loading changes and when the value changes',
          callbackTest((done) => {
        ...
        it(
          'should emit the loading state changes with the existing value',
          callbackTest((done) => {
            const obs = values$.pipe(distinctLoadingState(objectKeysEqualityComparatorFunction((x) => x)));
        ...
        it(
          'should emit the existing value with a new error',
          callbackTest((done) => {
            const obs = values$.pipe(distinctLoadingState(objectKeysEqualityComparatorFunction((x) => x)));
        ...
        it(
          'should clear existing value when null is passed as a value',
          callbackTest((done) => {
            const obs = values$.pipe(distinctLoadingState(objectKeysEqualityComparatorFunction((x) => x)));
        ...
        it(
          'should not emit when the value is considered equivalent',
          callbackTest((done) => {
            const obs = values$.pipe(distinctLoadingState(objectKeysEqualityComparatorFunction((x) => x)));
