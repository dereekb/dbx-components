...
describe('FilterMap', () => {
  ...
  describe('filterForKey()', () => {
    it(
      'should not return an filter if a filter has not been set for that key',
      callbackTest((done) => {
        filterMap
    ...
    it(
      'should return a filter if a filter is set for a key.',
      callbackTest((done) => {
        const testFilter = {};
    ...
    it(
      'should return a filter if a default filter obs is set for a key.',
      callbackTest((done) => {
        const testFilter = {};
    ...
    it(
      'should not return a filter if a default filter obs that has no value is set for a key.',
      callbackTest((done) => {
  ...
  describe('addFilterObs()', () => {
    it(
      'should recieve filters from all passed filters until the configured obs is marked complete.',
      callbackTest((done) => {
    ...
    it(
      'values from this observable should be returned instead of those from the default filter for that key.',
      callbackTest((done) => {
        const testFilterA = {};
        const testFilterB = {};
