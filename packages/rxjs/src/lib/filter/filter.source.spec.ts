...
describe('FilterSourceInstance', () => {
  ...
  describe('defaultFilter$', () => {
    it(
      'should not return any value if no default observable is set.',
      callbackTest((done) => {
  ...
  describe('initialFilter$', () => {
    it(
      'should not return any value if no default observable or initial observable is set.',
      callbackTest((done) => {
    ...
    it(
      'should return the default observable if no initial observable is set.',
      callbackTest((done) => {
    ...
    it(
      'should return the initial observable if both the default observable and initial observable is set.',
      callbackTest((done) => {
